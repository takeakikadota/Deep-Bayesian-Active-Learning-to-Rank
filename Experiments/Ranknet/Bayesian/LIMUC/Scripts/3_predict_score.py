...
#
# Example:
#   python 3_predict_score.py <result_date>
#   e.g., python 3_predict_score.py 20260825_161805_AL_0
#
# <result_date> refers to a training result directory generated by
...
def predict():
    ...
    weight_path_lst = sorted(
        os.path.join(weight_path, s)
        for s in os.listdir(weight_path)
        if s.endswith(".h5")
    )

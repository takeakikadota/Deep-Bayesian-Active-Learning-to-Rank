...
Here, `<AL_0_result_date>` is the result directory generated by the initial Bayesian RankNet training, and `<AL_1_result_date>` is the result directory generated by the first active-learning iteration.
